...
* [tests](./tests): Folder of SQL and Python scripts.
...
* **11. Add a new state**
  * [11-model_state_insert.y](./11-model_state_insert.py): Python script that
...
* **17. List city**
  ...
  * Results are sorted by ascending `cities.id`.p
